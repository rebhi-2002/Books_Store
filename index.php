...
<?php
$sql = "SELECT * FROM books ORDER BY RAND() DESC LIMIT 3"; // ASC
        ...
        <div class="content">
          ...
          <div class='input position-relative'>
            <form class="input-group my-4" method="GET">
              <input name="query" type="search" value="<?php if (isset($_GET['query'])) {
                                                          echo $_GET['query'];
                                                        } ?>" class="form-control rounded-1 m-auto w-75" placeholder="🔍 Search by book name, price, serial no., author, category: drama, ..." />
            ...
            if (isset($_GET['query'])) {
              ...
              if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<a class='text-decoration-none' href='book-details.php?id=" . $row['id'] . "'>";
                  echo '<img src="imgs/' . $row['image'] . '" style="max-width:120px;" >';
                  echo "<h5 class='font-weight-normal pt-3 opacity-75'>Title: <span class='text-black-50'>" . $row['name'] . "</span></h5>";
                  echo "<h5 class='font-weight-normal pt-3 opacity-75'>Author: <span class='text-black-50'>" . $row['author'] . "</span></h5>";
                  echo "<p class='lead opacity-75 '>Price: <span class='text-black-50'>" . $row['price'] . "</span></p>";
                  echo "</a>";
                  echo "</div>";
                  echo "<br>";
                }
                echo "<div class='rounded-4' style='width: 94%; height: 2px; background: blue; padding: 2px;'></div>";
                echo "</div>";
              } else {
                echo "<p class='text-info bg-light rounded-4 mb-5 p-5'><bdi>لم يتم العثور على أية نتائج.</bdi></p>";
              }
              $result->free_result();
            }
            $conn->close();
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input id="form_name" type="text" name="name2" class="form-control" placeholder="Please enter your name *" required="required" data-error="Name is required." />
