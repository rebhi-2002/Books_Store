...
<?php
$sql = "SELECT COUNT(*) AS bookCount FROM books WHERE name IS NOT NULL";
...
$categoriesSection = mysqli_query($conn, $sql);
?>

<?php
$sql = "SELECT * FROM books";
$booksSection = mysqli_query($conn, $sql);
?>
...
<body>
  ...
  <div class="settings-box">
    ...
    <div class="settings-container" style="overflow-y: scroll; height: 100vh">
      ...
      <div id="fontCustomization" class="option-box">
        ...
        <input type="range" id="fontThicknessRange" min="100" max="900" step="100"
          onchange="changeProperty('fontWeight' ,this.value)" />
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <div class="box position-relative">
              ...
              <span class="d-block my-2 fs-3"><?php echo $bookCount ?></span>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="box position-relative">
              ...
              <span class="d-block my-2 fs-3"><?php echo $authorCount ?></span>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="box position-relative">
              ...
              <span class="d-block my-2 fs-3"><?php echo $categoryCount ?></span>
  ...
  <div class="latest-categories text-center px-5">
    <div class="container">
      ...
      <div class="content">
        <?php
          while ($row = mysqli_fetch_assoc($categoriesSection)) { ?>
        <a <?php if (isset($_SESSION['user_id'])) {
                  echo "href='" . $row['name'] . "_category.php'";
                } ?>
        ...
        <?php } ?>
        <?php if (isset($_SESSION['user_id'])) { ?>
        <a href="computers_&_technology.php"
          class="text-nowrap btn w-25 lh-lg py-4 px-5 m-2 bg-white text-center d-inline-flex justify-content-center flex-wrap">
          Computers & Technology
        </a>
        <a href="most_popular.php"
          class="btn w-25 lh-lg py-4 px-5 m-2 bg-white text-center d-inline-flex justify-content-center flex-wrap">
          Most Popular
        </a>
    ...
    <div class="container">
      <div class="content">
        ...
        <div class="box mt-5 mx-5 d-flex justify-content-center flex-wrap">
          <?php
            while ($row = mysqli_fetch_assoc($booksSection)) { ?>
          <div class="card mx-3 mb-4 mt-auto" style="width: 18rem">
            <img src="imgs/<?php echo $row['image'] ?>" class="card-img-top" style="height: 430px; object-fit: cover"
              alt="..." />
            <div class="card-body">
  ...
  <section id="gallery">
    ...
    <div class="gallery-slider swiper">
      <div class="swiper-wrapper align-items-center">
        ...
        <div class="swiper-slide">
          <a href="imgs/slide_02.jpg" class="gallery-lightbox"><img src="imgs/slide_02.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_03.jpg" class="gallery-lightbox"><img src="imgs/slide_03.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_04.jpg" class="gallery-lightbox"><img src="imgs/slide_04.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_05.jpg" class="gallery-lightbox"><img src="imgs/slide_05.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_06.jpg" class="gallery-lightbox"><img src="imgs/slide_06.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_07.jpg" class="gallery-lightbox"><img src="imgs/slide_07.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_08.jpg" class="gallery-lightbox"><img src="imgs/slide_08.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_09.jpg" class="gallery-lightbox"><img src="imgs/slide_09.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_10.jpg" class="gallery-lightbox"><img src="imgs/slide_10.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_11.jpg" class="gallery-lightbox"><img src="imgs/slide_11.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_12.jpg" class="gallery-lightbox"><img src="imgs/slide_12.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_13.jpg" class="gallery-lightbox"><img src="imgs/slide_13.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_14.jpg" class="gallery-lightbox"><img src="imgs/slide_14.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_15.jpg" class="gallery-lightbox"><img src="imgs/slide_15.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_16.jpg" class="gallery-lightbox"><img src="imgs/slide_16.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_17.jpg" class="gallery-lightbox"><img src="imgs/slide_17.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_18.jpg" class="gallery-lightbox"><img src="imgs/slide_18.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_19.jpg" class="gallery-lightbox"><img src="imgs/slide_19.jpg" class="img-fluid"
              alt="" /></a>
        </div>
        <div class="swiper-slide">
          <a href="imgs/slide_20.jpg" class="gallery-lightbox"><img src="imgs/slide_20.jpg" class="img-fluid"
              alt="" /></a>
        </div>
      </div>
            ...
            <div class="controls">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input id="form_name" type="text" name="name2" class="form-control"
              ...
              <div class="form-group">
                ...
                <textarea id="form_message" name="message" class="form-control"
                  placeholder="Please enter your message *" rows="4" required="required"
