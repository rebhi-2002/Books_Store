  ...
  <div class="container py-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="book-details_3.php"><bdi>استمتع بحياتك</bdi></a></li>
  ...
  <div class="book-details my-4">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="info-box">
            <p class="fs-3 m-auto"><bdi>استمتع بحياتك</bdi></p>
            <span>Price: <span class="text-danger">7.00$</span></span>
            <hr />
            <p class="fs-14">Maiores et ratione v</p>
            <?php if (isset($_SESSION['user_id'])) { ?>
            <a href="add-to-cart.php?id=3" class="btn btn-success mt-3 mb-5 py-2 px-4 rounded-1">
